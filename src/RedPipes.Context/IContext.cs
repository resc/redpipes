...
namespace RedPipes
{
    ...
    /// but rather to store things like <see cref="RedPipes.Requests.RequestId"/> and authentication info for the user requesting the operation. 
    /// </remarks>
    public interface IContext
    {
        ...
        /// <returns>True if the key is associated with a value of type <typeparam name="T">T</typeparam>, false if the key is null, or the key is not known</returns>
